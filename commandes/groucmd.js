...
const {
  ...
  let _0x3f6faa;
  try {
    _0x3f6faa = await _0x4375b2.profilePictureUrl(_0x24f18e, "image")["catch"](() => "https://files.catbox.moe/87g5oe.jpeg");
  } catch (_0x6d1bf4) {
    _0x3f6faa = "https://files.catbox.moe/87g5oe.jpeg";
  }
...
zokou({
  ...
  await _0xb269b7("*HANS-MD is sending this message to all groups you are in*...");
  for (let _0x398282 of _0x115598) {
    let _0x25a35f = "⚠️⚠️𝑯𝑨𝑵𝑺-𝑴𝑫 𝑩𝑹𝑶𝑨𝑫𝑪𝑨𝑺𝑻⚠️⚠️\n\n🚩*message* : " + _0x1360fc + "\n\n️🚩 *𝐀𝐮𝐭𝐡𝐨𝐫*: " + _0x271224;
    await _0x4cdb8c.sendMessage(_0x398282, {
      'image': {
        'url': "https://files.catbox.moe/87g5oe.jpeg"
      },
      'caption': '' + _0x25a35f
    });
  }
...
zokou({
  ...
  try {
    ...
    for (let _0x269fcd of _0x267c2d) {
      ...
      let _0x5838c2 = _0x269fcd.name || _0x269fcd.notify || "[𝐇𝐀𝐍𝐒-𝐌𝐃] +" + _0x23a8f8;
      _0x4a6ecd += "BEGIN:VCARD\nVERSION:3.0\nFN:" + _0x5838c2 + "\nTEL;type=CELL;type=VOICE;waid=" + _0x23a8f8 + ':+' + _0x23a8f8 + "\nEND:VCARD\n";
    }
    await _0x2e5b52("A moment, *HANS-MD* is compiling " + _0x267c2d.length + " contacts into a vcf...");
